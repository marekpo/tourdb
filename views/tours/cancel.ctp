...
echo $this->Html->para('', __('Wenn du möchtest, kannst du den angemeldeten Teilnehmern der Tour noch eine persönliche Mitteilung machen. Wenn du das folgende Feld leer lässt, erhalten die angemeldeten Teilnehmer eine Standardmitteilung über die Absage der Tour.', true));
