...
{
?>
<?php echo $key + 1; ?>. "<?php echo $msgDataEntry['Tour']['title']; ?>" geändert: <?php echo date('d.m.Y H:i', strtotime($msgDataEntry['Tour']['modified'])); ?> Status: <?php echo $msgDataEntry['TourStatus']['statusname']; ?>
