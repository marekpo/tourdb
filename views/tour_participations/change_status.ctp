...
echo $this->Html->para('', __('Wenn du möchtest, kannst du dem Teilnehmer mit der Statusänderung noch eine persönliche Mitteilung machen. Wenn du das folgende Feld leer lässt, erhält der Teilnehmer eine Standardmitteilung (E-Mail) über die Statusänderung seiner Anmeldung.', true));
