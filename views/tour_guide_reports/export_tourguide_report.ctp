...
echo $this->Html->para('', sprintf(__('Hier kannst du den Tourenrapport für die Tour "%s" herunterladen. Bitte danach noch kontrolieren und an die Tourenkommision per eMail abschicken!', true), $this->data['Tour']['title']));
