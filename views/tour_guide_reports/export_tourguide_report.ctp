...
echo $this->Html->para('', sprintf(__('Hier kannst du den Tourenrapport für die Tour "%s" herunterladen. Bitte danach noch kontrollieren und an die Tourenkommission per E-Mail abschicken!', true), $this->data['Tour']['title']));
